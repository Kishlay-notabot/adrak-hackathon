        ...
        <main className="flex-1 overflow-auto p-6">
          <Card className="bg-white border-[#E2E8F0] shadow-sm">
            <CardContent className="flex flex-col items-center justify-center py-20">
              ...
              <h3 className="text-lg font-semibold text-[#0F172A] mb-2">Reports & Analytics</h3>
              <p className="text-sm text-[#64748B] text-center max-w-md">
                Detailed reports on patient flow, bed occupancy, and OPD usage
                will appear here. Visit the Dashboard for current stats.
              </p>
            </CardContent>
          </Card>
        </main>
